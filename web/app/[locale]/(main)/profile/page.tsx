      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between">
            <p className="text-base font-medium">{t('profile.nextLevel')}</p>
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          >
            ...
            <p className="text-white/60 text-xs">{t('profile.stats.roastsWon')}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-white/60 text-xs">{t('profile.stats.followers')}</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-white/60 text-xs">{t('profile.stats.ranking')}</p>
          </motion.div>
        </div>

        {/* Activity Section */}
        <div className="flex flex-col gap-4">
          <h2 className="text-2xl font-bold">{t('profile.recentActivity')}</h2>
          ...
          <div className="flex flex-col gap-3">
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-white text-base font-medium">{t('profile.activities.roastBattle')} @CyberSlayer</p>
                <p className="text-white/60 text-sm">{t('profile.latestRoasts')}</p>
              </div>
              <p className="text-white/60 text-sm">{t('profile.timeAgo.hour')}</p>
            </motion.div>
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-white text-base font-medium">{t('profile.activities.wonRoast')} @ComedyKing</p>
                <p className="text-white/60 text-sm">{t('profile.latestRoasts')}</p>
              </div>
              <p className="text-white/60 text-sm">{t('profile.timeAgo.hours').replace('{hours}', '2')}</p>
            </motion.div>
            ...
            >
              ...
              <div className="flex-1">
                <p className="text-white text-base font-medium">{t('profile.activities.commented')} @PixelPunisher's roast</p>
                <p className="text-white/60 text-sm">{t('profile.community')}</p>
              </div>
              <p className="text-white/60 text-sm">{t('profile.timeAgo.hours').replace('{hours}', '5')}</p>
            </motion.div>
          </div>
        </div>
        ...
        {/* Leaderboards */}
        <div className="flex flex-col gap-4">
          <h2 className="text-2xl font-bold">{t('profile.leaderboards')}</h2>
        ...
        >
          <h2 className="text-2xl font-bold">{t('profile.myWallet')}</h2>
          <div className="flex items-center justify-between">
            <p className="text-white/60">{t('profile.balance')}</p>
            <p className="text-2xl font-bold flex items-center gap-2 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)]">
              <span className="text-yellow-400">💰</span>
              {profile.coins.toLocaleString()} {t('profile.coins')}
            </p>
          </div>
